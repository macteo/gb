class ClubsController < ApplicationController
  ...
  private
    ...
    def club_params
      params.require(:club).permit(:address, :closed, :contacts, :email, :fax, :instructions, :latitude, :longitude, :name, :note, :path, :position, :season, :telephone, :website, :image_id, :file)
    end
end
