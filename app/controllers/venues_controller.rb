class VenuesController < ApplicationController
  ...
  private
    ...
    def venue_params
      params.require(:venue).permit(:address, :category, :closed, :contacts, :desc, :email, :instructions, :latitude, :longitude, :name, :note, :path, :telephone, :website, :image_id, :file)
    end
end
