  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved sponsor as @sponsor" do
        ...
        post :create, {:sponsor => { "title" => "invalid value" }}, valid_session
        assigns(:sponsor).should be_a_new(Sponsor)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested sponsor" do
        ...
        Sponsor.any_instance.should_receive(:update).with({ "title" => "MyString" })
        put :update, {:id => sponsor.to_param, :sponsor => { "title" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the sponsor as @sponsor" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Sponsor.any_instance.stub(:save).and_return(false)
        put :update, {:id => sponsor.to_param, :sponsor => { "title" => "invalid value" }}, valid_session
        assigns(:sponsor).should eq(sponsor)
      end
