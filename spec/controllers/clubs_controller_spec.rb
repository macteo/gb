  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved club as @club" do
        ...
        post :create, {:club => { "address" => "invalid value" }}, valid_session
        assigns(:club).should be_a_new(Club)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested club" do
        ...
        Club.any_instance.should_receive(:update).with({ "address" => "MyText" })
        put :update, {:id => club.to_param, :club => { "address" => "MyText" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the club as @club" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Club.any_instance.stub(:save).and_return(false)
        put :update, {:id => club.to_param, :club => { "address" => "invalid value" }}, valid_session
        assigns(:club).should eq(club)
      end
